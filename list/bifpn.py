...
def build_resnet_bifpn_backbone(cfg, input_shape: ShapeSpec):
  ...
  Returns:
      backbone (Backbone): backbone module, must be a subclass of :class:`Backbone`.
  """
    bottom_up=BACKBONE_REGISTRY.get('build_resnet_backbone')(cfg, input_shape)
...
@BACKBONE_REGISTRY.register()
def build_mobilenetv3large_bifpn_backbone(cfg, input_shape: ShapeSpec):
    """
  Args:
      cfg: a detectron2 CfgNode
  Returns:
      backbone (Backbone): backbone module, must be a subclass of :class:`Backbone`.
  """
    bottom_up=BACKBONE_REGISTRY.get('build_mobilenetv3large_backbone')(cfg, input_shape)
